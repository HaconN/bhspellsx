...
public final class XianSheHuanYingConstants {
    ...
    /** Eye image, floating above the target's head. Size in blocks. */
    public static final float EYE_WIDTH = 1.0f;
    public static final float EYE_HEIGHT = 1.0f;
    /** Height of the eye quad's CENTER above the target's feet — fallback only, used when the
    ...
    // and the snake image (round 3) --------------------------------------------------------------

    public static final int CLOUD_COUNT = 6;
    /** Horizontal distance from the mist group's center. Kept above ~1 block so a cloud can never
     *  clip through the player model. */
    public static final float CLOUD_ORBIT_RADIUS_MIN = 1.2f;
    public static final float CLOUD_ORBIT_RADIUS_MAX = 2.2f;
